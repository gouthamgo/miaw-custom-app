...
export default function MessagingBody({ conversationEntries, conversationStatus, typingParticipants, showTypingIndicator,onChoiceSelect }) {
    ...
    const conversationEntriesListView = conversationEntries.map(conversationEntry =>
        <ConversationEntry
            ...
            onChoiceSelect={onChoiceSelect} />  // Pass it through
    );
